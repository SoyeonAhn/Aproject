			...
			<div class="col-md-3">
				...
				<div class="list-grozup">
					<a href="/personal/index" class="list-group-item">개인정보관리 P_index</a><!-- p08 --> <a
						...
						href="/personal/recom" class="list-group-item">추천채용공고 P_recom</a> <!-- p04 --><a
						href="/personal/favor" class="list-group-item">관심채용공고 P_favor</a> <!-- p05 --><a
						href="/personal/applied" class="list-group-item">지원현황리스트 P_applied</a><!-- p07 -->
				</div>
			</div>